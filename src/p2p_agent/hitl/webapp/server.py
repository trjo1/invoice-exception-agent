...
def create_app(
    ...
    # All docs are hand-crafted HTML in the repo root for consistency —
    # markdown sources (e.g. docs/decision_log.md) are kept in the repo for
    # authoring but the served version is the pre-rendered .html.
    _DOC_FILES = {
        ...
        "decision_log":      _REPO_ROOT / "decision_log.html",
    }
