# Invoice generation — batch 59 of 100
...
### Invoice 1
- persona_id: P001
- persona_name: Global Tech Components Inc.
- region: US
- language: en
- currency: USD
...
- line_items: about 8
- invoice_date around: 2026-02-17
...
- payment_terms: NET-30
- line_items: about 1
- invoice_date around: 2026-01-25
- error_injected: Cross-currency edge when buyer is in USD
- persona quirks to reflect:
...
- line_items: about 8
- invoice_date around: 2026-03-24
- error_injected: HSN code formatting inconsistent (with/without dashes)
- persona quirks to reflect:
...
- payment_terms: NET-30
- line_items: about 2
- invoice_date around: 2026-02-01
- error_injected: Multi-page invoices where line-items continue across pages
- persona quirks to reflect:
      - Multi-currency invoicing when shipping abroad
      - Tax line itemized separately by jurisdiction
      - Round totals to 2 decimals
...
- payment_terms: NET-30
- line_items: about 2
- invoice_date around: 2026-03-17
- error_injected: Multiple tax types confuse extraction
- persona quirks to reflect:
